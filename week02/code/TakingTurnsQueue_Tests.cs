...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Test passed. The queue correctly cycles through people with finite turns and empties as expected.
    ...
    // Defect(s) Found: Test passed. Adding a person mid-way works as expected; the queue order and depletion are correct.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Test passed. People with zero turns are treated as infinite; infinite turns are not replaced with a large number.
    ...
    // Defect(s) Found: Test passed. Negative turns are treated as infinite; infinite turns are not replaced with a large number.
    ...
    // Defect(s) Found: Test passed. Exception is thrown with the correct message when queue is empty.
